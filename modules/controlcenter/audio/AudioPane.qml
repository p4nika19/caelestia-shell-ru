                    ...
                    CollapsibleSection {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                StyledText {
                                    text: qsTr("Устройства (%1)").arg(Audio.sinks.length)
                            ...
                            StyledText {
                                Layout.fillWidth: true
                                text: qsTr("Все доступные устройства вывода")
                                ...
                                delegate: StyledRect {
                                    ...
                                    RowLayout {
                                        ...
                                        StyledText {
                                            ...
                                            text: modelData.description || qsTr("Неизвестно")
                    ...
                    CollapsibleSection {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                StyledText {
                                    text: qsTr("Устройства (%1)").arg(Audio.sources.length)
                                    font.pointSize: Appearance.font.size.normal
                                    font.weight: 500
                                }
                            }
                            ...
                            StyledText {
                                Layout.fillWidth: true
                                text: qsTr("Все доступные устройства ввода")
                                color: Colours.palette.m3outline
                            }
        ...
        rightContent: Component {
            StyledFlickable {
                ...
                ColumnLayout {
                    ...
                    SectionHeader {
                        title: qsTr("Громкость вывода")
                        description: qsTr("Управлению громкостью устройств вывода")
                    }
                    ...
                    SectionHeader {
                        title: qsTr("Громкость ввода")
                        description: qsTr("Управлению громкостью устройств ввода")
                    }
                    ...
                    SectionHeader {
                        title: qsTr("Приложения")
                        description: qsTr("Управлению громкостью для определённых приложений")
                    }
                    ...
                    SectionContainer {
                        ...
                        ColumnLayout {
                            ...
                            StyledText {
                                ...
                                text: qsTr("Приложения сейчас не воспроизводят аудио")
                                color: Colours.palette.m3outline
